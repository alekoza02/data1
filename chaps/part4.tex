...
\paragraph{Part 1:} Same K, simple oval domain, plot the result:
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/fra_ex_1_1.png}
    \caption{Energy curve @ 961°C}
    \label{fig:fra_ex_1_1}
\end{figure}

\paragraph{Part 2:} With different K and a sub - domain, plot the results:
\begin{lstlisting}[style=cppstyle]
// ex 1
load "medit"
