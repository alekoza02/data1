...
\subsection{Ex 1: Deformation of an Elliptical Membrane with Spatially Varying Stiffness}
...
\newpage
\subsection{Ex 2: 3D Hydrogen Diffusion in a Bolt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/logo_vite.png}
    \caption{Wireframe mesh model of the bolt}
    \label{fig:3d_mesh_wireframe}
\end{figure}
