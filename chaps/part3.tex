...
\paragraph{Costs:} We have set a limit on the geometry of our material so that it is as similar as possible to a bicycle helmet, as shown in Fig. \ref{fig:forma}. This limit allows the program to select all materials that can achieve the desired shape through various industrial processes.
...
\paragraph{Limits:} We set up the material index based on cost (see Fig. \ref{fig:dome_3}):
...
In the section “Material, manufacture, and end of life,” we considered a quantity of 1,000 helmets, with no recycled content and a mass of 0.15 kg (ChatGPT). For the end of life of the material, Downcycle was chosen for both, as the two materials cannot be recycled.
