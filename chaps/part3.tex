...
\paragraph{Material indeces:} First of all, we chose the geometry that best approximates the final object we need to build. Next, we based our design on Stiffness-limited-Design at minimum mass.
...
\noindent Next, we maximized the Strength-limited-Design at minimum mass:

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{images/dome_data2.png}
    \caption{Function, Constraints and formula to maximize}
    \label{fig:dome_2}
\end{figure}

\newpage
\noindent \textbf{Ashby charts:}
...
\noindent This time, we positioned the line so as to select only one candidate material, which corresponds to the most economical helmet option, as shown in Fig. \ref{fig:cip_ciop}.
...
\noindent The material found is \texttt{Fir (abies lasiocarpa) (longitudinal)}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{images/ecoaudit_project_carbon_fiber.JPG}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\linewidth]{images/ecoaudit_project_fir.JPG}
...
\noindent To do this, we had to compile the various categories by entering the values for Fir (Abies lasiocarpa) (l) and Cyanate ester/HM carbon fiber in the Eco Audit Project, taking into account the recycling and end-of-life parameters present in the database for the two materials (figures below).
...
\noindent In the program section \texttt{Material, manufacture, and end of life} we considered a quantity of 1000 helmets, with no recycled content and an estimated mass of 0.15 kg. For the end of life of the material, Downcycle was chosen for both, as the two materials cannot be recycled.
