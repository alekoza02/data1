...
\begin{lstlisting}[style=pythonstyle]
    ...
    y_proba_1
\end{lstlisting}
\textbf{output:} \texttt{array([[6.83166501e-09, 9.99999993e-01]])}, meaning the model is 99.9999993\% sure the answer is the flower is Virginica.
...
\end{lstlisting}
\vspace{0.3cm}
\textbf{output:} \texttt{array([[0.02404399, 0.96249222, 0.01346379]])}, meaning the model is 96.249222\% sure the answer is the flower is Versicolor. Other probabilities are reffered to `setosa' and `virginica'.
