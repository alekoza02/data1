...
\newpage
\subsection{Exercise 2} \textcolor{red}{Manca il grafico della leva (graficamente e con PANDAT) solo su un grafico (Dario). Commenti (Fra).
}
\begin{figure}[H]
    \centering
...
\newpage
\subsection{Exercise 4} \textcolor{red}{Manca il grafico della leva (graficamente e con PANDAT) solo su un grafico (Dario). Commenti (Fra).}
...
\noindent The phases that are present are:
...
\noindent We have one invariant point that is a eutectic reaction at approximately x(Li) =1 and T=180 °C.

\noindent L→Cu+Li

\noindent This is a 3-phase equilibrium and so one invariant point.
